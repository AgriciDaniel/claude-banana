...
- **Edit-First principle** elevated to core principle with decision matrix
...
- Prompt engineering approach: "Start with Intent, Refine with Specs"
- Fallback chain expanded: MCP → Replicate → Direct Gemini API

### Fixed
- Free tier rate limits in cost-tracking.md corrected to ~5-15 RPM / ~20-500 RPD (was ~10 / ~500)
- Output tokens per image note updated across docs
...
[1.5.0]: https://github.com/AgriciDaniel/banana-claude/releases/tag/v1.5.0
